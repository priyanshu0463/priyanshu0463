...
<div style="position: relative;">
    <div>
        <p style="display: inline-block;">💼 Open for Opportunities</p>
        <img align="right" alt="GIF" src="https://github.com/abhisheknaiidu/abhisheknaiidu/blob/master/code.gif?raw=true" width="440" height="300" style="border-radius: 20px; position: absolute; right: 0; top: 0;" />
    </div>
</div>
...
<div style="position: relative;">
    <div>
        <p style="display: inline-block;">🌐 Let's Connect</p>
        <img align="right" alt="GIF" src="https://github.com/abhisheknaiidu/abhisheknaiidu/blob/master/code.gif?raw=true" width="440" height="300" style="border-radius: 20px; position: absolute; right: 0; top: 0;" />
    </div>
</div>
